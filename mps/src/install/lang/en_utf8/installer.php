...
/// (langconfig.php, install.php, Marsupial Publisher Simulator.php, admin.php and error.php)
///
/// If you find some missing string in Marsupial Publisher Simulator installation, please,
/// keep us informed using http://Marsupial Publisher Simulator.org/bugs Thanks!
///
...
$string['admindirsettingsub'] = 'A very few webhosts use /admin as a special URL for you to access a 
    ...
    standard location for the Marsupial Publisher Simulator admin pages.  You can fix this by 
    renaming the admin directory in your installation, and putting that 
    new name here.  For example: <br /> <br /><b>Marsupial Publisher Simulatoradmin</b><br /> <br />
    This will fix admin links in Marsupial Publisher Simulator.';
...
$string['chooselanguagesub'] = 'Please choose a language for the installation ONLY.';
$string['closewindow'] = 'Close this window';
$string['compatibilitysettingshead'] = 'Checking your PHP settings ...';
$string['compatibilitysettingssub'] = 'Your server should pass all these tests to make Marsupial Publisher Simulator run properly';
$string['componentisuptodate'] = 'Component is up-to-date';
$string['configfilenotwritten'] = 'The installer script was not able to automatically create a config.php file containing your chosen settings, probably because the Marsupial Publisher Simulator directory is not writeable. You can manually copy the following code into a file named config.php within the root directory of Marsupial Publisher Simulator.';
...
$string['configurationcompletesub'] = 'Marsupial Publisher Simulator made an attempt to save your configuration in a file in the root of your Marsupial Publisher Simulator installation.';
...
$string['ctyperequired'] = 'The ctype PHP extension is now required by Marsupial Publisher Simulator, in order to improve site performance and to offer multilingual compatibility.';
$string['curlrecommended'] = 'Installing the optional cURL library is highly recommended in order to enable Marsupial Publisher Simulator Networking functionality.';
$string['customcheck'] = 'Other Checks';
$string['database'] = 'Database';
$string['databasecreationsettingshead'] = 'Now you need to configure the database settings where most Marsupial Publisher Simulator data
...
$string['databasecreationsettingssub'] = '<b>Type:</b> fixed to \"mysql\" by the installer<br />
       <b>Host:</b> database host name, eg \"localhost\"<br />
       <b>Name:</b> database name, eg MPS<br />
       <b>User:</b> database username, eg \"root\"<br />
       <b>Password:</b> your database password<br />
       <b>Tables Prefix:</b> optional prefix to use for all table names';
$string['databasesettingshead'] = 'Now you need to configure the database where most Marsupial Publisher Simulator data
...
$string['databasesettingssub'] = '<b>Type:</b> mysql or postgres7<br />
       ...
       <b>Name:</b> database name, eg Marsupial Publisher Simulator<br />
...
$string['directorysettingshead'] = 'Please confirm the locations of this Marsupial Publisher Simulator installation';
$string['directorysettingssub'] = '<p><b>Web Address:</b>
Specify the full web address where Marsupial Publisher Simulator will be accessed.  
...
a trailing slash.</p>
<p><b>Marsupial Publisher Simulator Directory:</b>
Specify the full directory path to this installation
Make sure the upper/lower case is correcti, and you have write permissions on that folder and the folder one level up where configuration file is goind to be save.</p>
...
$string['environmenterrortodo'] = 'You must solve all the environmental problems (errors) found above before proceeding to install this Marsupial Publisher Simulator version!';
...
<p>Marsupial Publisher Simulator can still be installed, but without this ability, you will not be able 
...
<p>GD is a library that is required by PHP to allow Marsupial Publisher Simulator to process images 
   (such as the user profile icons) and to create new images (such as 
   the log graphs).  Marsupial Publisher Simulator will still work without GD - these features 
...
$string['magicquotesruntimehelp'] = '<p>Magic quotes runtime should be turned off for Marsupial Publisher Simulator to function properly.</p>
...
<p>This may cause Marsupial Publisher Simulator to have memory problems later on, especially 
...
<li>If you are able to, recompile PHP with <i>--enable-memory-limit</i>.  
    This will allow Marsupial Publisher Simulator to set the memory limit itself.</li>
...
<li>On some PHP servers you can create a .htaccess file in the Marsupial Publisher Simulator directory 
...
$string['Marsupial Publisher Simulatordocslink'] = 'Marsupial Publisher Simulator Docs for this page';
...
$string['mysql416required'] = 'MySQL 4.1.16 is the minimum version required for Marsupial Publisher Simulator 1.6 in order to guarantee that all data can be converted to UTF-8 in the future.';
...
$string['ok'] = 'OK';
$string['opensslrecommended'] = 'Installing the optional OpenSSL library is highly recommended -- it enables Marsupial Publisher Simulator Networking functionality.';
...
$string['phpversionhelp'] = '<p>Marsupial Publisher Simulator requires a PHP version of at least 4.3.0 or 5.1.0 (5.0.x has a number of known problems).</p>
...
and to leave empty the Database, User and Password fields. More information on <a href=\"http://docs.Marsupial Publisher Simulator.org/en/Installing_Postgres_for_PHP\">Marsupial Publisher Simulator Docs</a>';
...
$string['qtyperqpwillberemovedanyway'] = 'During the upgrade, the RQP question type will be removed. You have some RQP questions in your database, and these will stop working unless you reinstall the code from http://Marsupial Publisher Simulator.org/mod/data/view.php?d=13&amp;rid=797 before continuing with the upgrade.';
...
$string['safemodeerror'] = 'Marsupial Publisher Simulator may have trouble with safe mode on';
$string['safemodehelp'] = '<p>Marsupial Publisher Simulator may have a variety of problems with safe mode on, not least is that 
...
<p>Safe mode is usually only enabled by paranoid public web hosts, so you may have 
   to just find a new web hosting company for your Marsupial Publisher Simulator site.</p>
...
$string['sessionautostarthelp'] = '<p>Marsupial Publisher Simulator requires session support and will not function without it.</p>
...
$string['welcomep30'] = 'The minin requirement to use this version of the <strong>Marsupial Publisher Simulator</strong> are:';
$string['welcomep40'] = 'The package also includes <strong>Marsupial Publisher Simulator $a->Marsupial Publisher Simulatorrelease ($a->Marsupial Publisher Simulatorversion)</strong>.';
...
$string['welcomep60'] = 'The following pages will lead you through some easy to follow steps to 
    configure and set up <strong>Marsupial Publisher Simulator</strong> on your computer. You may accept the default 
    settings or, optionally, amend them to suit your own needs.';
$string['welcomep70'] = 'Click the \"Next\" button below to continue with the set up of <strong>Marsupial Publisher Simulator</strong>.';
