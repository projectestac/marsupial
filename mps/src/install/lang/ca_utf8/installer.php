...
/// (langconfig.php, install.php, Simulador d\'Editorial Marsupial.php, admin.php and error.php)
///
/// If you find some missing string in Simulador d\'Editorial Marsupial installation, please,
/// keep us informed using http://Simulador d\'Editorial Marsupial.org/bugs Thanks!
///
...
$string['admindirsettingsub'] = 'Alguns proveïdors d\'espai web utilitzen /admin com una adreça URL especial per accedir a un tauler de control o quelcom semblant. Malauradament això interfereix amb la ubicació estàndard de les pàgines d\'administració de Simulador d\'Editorial Marsupial. Podeu solucionar aquest problema canviant el nom del directori admin en la vostra instal·lació i introduint aquí el nou nom. Per exemple: <br /> <br /><b>Simulador d\'Editorial Marsupialadmin</b><br /> <br />
Això repararà tots els enllaços d\'administració de Simulador d\'Editorial Marsupial.';
...
$string['chooselanguagesub'] = 'Trieu un idioma NOMÉS per a la instal·lació.';
$string['closewindow'] = 'Tanca aquesta finestra';
$string['compatibilitysettingshead'] = 'S\'estan comprovant els paràmetres del PHP...';
$string['compatibilitysettingssub'] = 'El vostre servidor hauria de passar totes aquestes proves per tal que Simulador d\'Editorial Marsupial funcioni correctament.';
$string['componentisuptodate'] = 'El component està al dia';
$string['configfilenotwritten'] = 'La seqüència d\'instal·lació no ha estat capaç de crear automàticament un fitxer config.php que contingui els paràmetres que heu triat, probablement perquè no pugui escriure al directori de Simulador d\'Editorial Marsupial. Podeu copiar a mà el codi següent en un fitxer anomenat config.php dins del directori arrel de Simulador d\'Editorial Marsupial.';
...
$string['configurationcompletesub'] = 'Simulador d\'Editorial Marsupial ha intentat desar la configuració en un fitxer en l\'arrel de la vostra instal·lació de Simulador d\'Editorial Marsupial.';
...
$string['ctyperequired'] = 'A hores d\'ara Simulador d\'Editorial Marsupial requereix l\'extensió de PHP ctype, a fi de millorar el rendiment del lloc i oferir compatibilitat amb diferents idiomes.';
$string['curlrecommended'] = 'Es recomana instal·lar la biblioteca opcional Curl a fi d\'habilitar la funcionalitat de Simulador d\'Editorial Marsupial en Xarxa.';
$string['curlrequired'] = 'L\'extensió de PHP cURL és ara necessària per a comunicar-se amb repositoris Simulador d\'Editorial Marsupial.'; // ORPHANED
$string['customcheck'] = 'Altres comprovacions';
$string['database'] = 'Base de dades';
$string['databasecreationsettingshead'] = 'Ara cal configurar els paràmetres de la base de dades on s\'emmagatzemaran la majoria de dades de Simulador d\'Editorial Marsupial. L\'instal·lador crearà automàticament aquesta base de dades amb els paràmetres que especifiqueu aquí.';
$string['databasecreationsettingssub'] = '<b>Tipus:</b> fixat a \"mysql\" per l\'instal·lador<br />
<b>Servidor:</b> nom del host on es troba la base de dades, p. ex. \"localhost\"<br />
<b>Nom:</b> nom de la base de dades, p. ex. mps<br />
<b>Usuari:</b> nom de l\'usuari de la base de dades, p. ex. \"root\"<br />
<b>Contrasenya:</b> la contrasenya de l\'usuari de la base de dades<br />
<b>Prefix de les taules:</b> prefix opcional per utilitzar en els noms de totes les taules';
$string['databasesettingshead'] = 'Ara cal configurar la base de dades on s\'emmagatzemaran la majoria de dades de Simulador d\'Editorial Marsupial Publisher Simulator. Aquesta base de dades s\'ha d\'haver creat abans i cal tenir un nom d\'usuari i una contrasenya per accedir-hi.';
$string['databasesettingssub'] = '<b>Tipus:</b> mysql o postgres7<br />
<b>Servidor:</b> p. ex. localhost o db.isp.com<br />
<b>Nom:</b> nom de la base de dades, p. ex. Simulador d\'Editorial Marsupial<br />
...
$string['directorysettingshead'] = 'Confirmeu les ubicacions d\'aquesta instal·lació de Simulador d\'Editorial Marsupial.';
$string['directorysettingssub'] = '<p><b>Adreça web:</b>
Especifiqueu l\'adreça web completa per a accedir a Simulador d\'Editorial Marsupial. Si el vostre lloc és accessible per mitjà de diversos URL, trieu el més natural per als estudiants. No inclogueu la barra final.</p>
...
$string['environmenterrortodo'] = 'Abans d\'instal·lar aquesta versió de Simulador d\'Editorial Marsupial heu de resoldre tots els problemes d\'entorn (errors) que s\'han trobat.';
...
<p>Simulador d\'Editorial Marsupial es pot instal·lar igualment, però sense aquesta capacitat no podreu penjar fitxers als cursos o imatges dels usuaris.</p>
...
<p>GD és una biblioteca requerida pel PHP per tal que Simulador d\'Editorial Marsupial pugui processar imatges (p. ex. les icones dels perfils d\'usuari) i crear imatges noves (p. ex. els gràfics dels registres d\'activitat). Simulador d\'Editorial Marsupial pot funcionar sense GD, però aquestes característiques no estaran disponibles.</p>
...
<p>Si no teniu accés al php.ini, potser podreu afegir les línies següents en un fitxer anomenat .htaccess dins del directori Simulador d\'Editorial Marsupial:
<blockquote>php_value magic_quotes_gpc On</blockquote>
<blockquote>php_value register_globals Off</blockquote>
</p>';
$string['globalswarning'] = '<p><strong>Avís de seguretat</strong>: per a operar adequadament, Simulador d\'Editorial Marsupial necessita <br />que feu certs canvis en els paràmetres actuals del PHP.<p/><p><em>Cal</em> que definiu <code>register_globals=off</code>.<p>Aquest paràmetre es defineix en el fitxer <code>php.ini</code>, en la configuració d\'Apache/IIS <br />o en el fitxer <code>.htaccess</code>.</p>';
$string['help'] = 'Ajuda';
...
$string['magicquotesruntimehelp'] = '<p>Aquest paràmetre hauria d\'estar desactivat per tal que Simulador d\'Editorial Marsupial funcioni correctament.</p>

<p>Normalment està desactivat per defecte. Comproveu el valor de <b>magic_quotes_runtime</b> al vostre fitxer php.ini.</p>

<p>Si no teniu accés al php.ini, hauríeu de col·locar la línia següent en un fitxer anomenat .htaccess dins del directori de Simulador d\'Editorial Marsupial:
...
<p>Això pot causar que Simulador d\'Editorial Marsupial tingui problemes de memòria més endavant, especialment si teniu molts mòduls habilitats i/o molts usuaris.</p>
...
<ol>
<li>Si podeu, recompileu el PHP amb <i>--enable-memory-limit</i>. Això permetrà que Simulador d\'Editorial Marsupial defineixi el límit de memòria per si mateix.</li>
...
<li>En alguns servidors PHP podeu crear un fitxer .htaccess dins del directori de Simulador d\'Editorial Marsupial amb aquesta línia:
...
$string['Simulador d\'Editorial Marsupialdocslink'] = 'Documentació de Simulador d\'Editorial Marsupial per a aquesta pàgina';
...
$string['mysql416required'] = 'MySQL 4.1.16 és la versió mínima requerida per Simulador d\'Editorial Marsupial 1.6 a fi de garantir la conversió de totes les dades a UTF-8 en el futur.';
...
$string['ok'] = 'OK';
$string['opensslrecommended'] = 'Es recomana instal·lar la biblioteca OpenSSL per habilitar la funcionalitat de Simulador d\'Editorial Marsupial en Xarxa.';
...
$string['safemodeerror'] = 'Simulador d\'Editorial Marsupial pot tenir problemes amb el mode segur activat';
$string['safemodehelp'] = '<p>Simulador d\'Editorial Marsupial pot tenir diversos problemes amb el mode segur activat. Probablement no podrà crear fitxers nous.</p>

<p>Normalment el mode segur només està habilitat en servidors webs públics una mica paranoics, de manera que és probable que hàgiu de buscar un altre servei d\'allotjament per al vostre Simulador d\'Editorial Marsupial.</p>
...
$string['sessionautostarthelp'] = '<p>Simulador d\'Editorial Marsupial necessita suport per a sessions i no funcionarà sense.</p>
...
$string['welcomep30'] = 'Els requisit m&iacute;nins necessaris per fer servir aquesta versi&oacute; del <strong>Simulador d\'Editorial Marsupial</strong> s&oacute;n:';
$string['welcomep40'] = 'El paquet inclou també <strong>Simulador d\'Editorial Marsupial $a->Simulador d\'Editorial Marsupialrelease ($a->Simulador d\'Editorial Marsupialversion)</strong>.';
...
$string['welcomep60'] = 'Les pàgines següents us guiaran per una sèrie de passos fàcils de seguir per configurar <strong>Simulador d\'Editorial Marsupial</strong> en el vostre ordinador. Podeu acceptar els paràmetres per defecte o, opcionalment, modificar-los perquè s\'ajustin a les vostres necessitats.';
$string['welcomep70'] = 'Feu clic en el botó \"Següent\" per continuar la configuració de <strong>Simulador d\'Editorial Marsupial</strong>.';
