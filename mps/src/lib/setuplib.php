...
function make_upload_directory($directory, $shownotices=true) {
    ...
    $cnt=1;
    //echo "START ANALIZING--------------------------------------------------------------------------------<br>";  //debug mode
    //echo "currdir: ".$currdir."<br>";  //debug mode
    //echo "dirarray: "; print_r($dirarray); echo "<br><br>";  //debug mode
    foreach ($dirarray as $dir) {
    	//echo $cnt.". ANALIZING ------------------------------<br>";  //debug mode
        $currdir = $currdir .'/'. $dir;
        //echo $cnt.". dir: ".$dir."<br>";  //debug mode
        //echo $cnt.". is_int: "; print_r(is_numeric($dir)); echo "<br>";  //debug mode
        //echo $cnt.". currdir: ".$currdir."<br>";  //debug mode
        if (!file_exists($currdir)) { 
        	//echo $cnt.". file no exits";  //debug mode
            if (! mkdir($currdir, $CFG->directorypermissions)) {
            	//echo $cnt.". mkdir no created";  //debug mode
                if ($shownotices) {
        ...
        //echo $cnt.". END ANALIZING-----------------------------<br><br>" ;  //debug mode
        $cnt++;
    }
    //echo "END ANALIZING------------------------------------------------------------------------<br><br><br>";  //debug mode
    return $currdir;
}
