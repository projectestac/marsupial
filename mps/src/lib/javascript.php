...
// *********** END
// IECISA -> MPS ************ ADDED -> load jquery lib
?>
<script type="text/javascript" src="<?php echo $CFG->httpswwwroot ?>/lib/jquery/jquery.js"></script>
<?php 
// ********** END

// IECISA -> MPS *********** DELETED -> take out. It is not useful for us  
