...
var grade3 = 0;
var grade4 = 0;
var completed = 1; //0=NO_INICIADO, 1=FINALIZADO, 2=INCOMPLETO
		...
		function getAnswer()
        {
            ...
            if (!q0done && !q1done && !q2done && !q3done){
            	completed = 0;
            } else if (!q0done || !q1done || !q2done || !q3done){
            	completed = 2;
            }
        ...
        function calcScore2()
        {
           ...
           //send form by ajax
           var dataString = "token="+$("#token").val()+"&key0b20="+question0+"&key1b20="+question1+"&key2b20="+question2+"&key3b20="+question3+"&grade_1="+grade1+"&grade_2="+grade2+"&grade_3="+grade3+"&grade_4="+grade4+"&totalgrade="+actualScore+"&gradeunit=1";
           if (completed == 2){
        	   dataString += "&gradestate=INCOMPLETO";
           } else if (completed == 0){
        	   dataString += "&gradestate=NO_INICIADO";
           }
           //alert(dataString);  //debug purpose
           ...
           $.ajax({  
        	   ...
        	   success: function(data, textStatus, XMLHttpRequest) {  
        		   ...
        		   if (data != 'OK'){
        			   //alert("response KO"); //just for debug purpose
        			   if ($(".notifingtext")){
