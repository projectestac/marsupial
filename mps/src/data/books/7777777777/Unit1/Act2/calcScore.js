...
var completed = 1; //0=NO_INICIADO, 1=FINALIZADO, 2=INCOMPLETO
        ...
        function calcScore2()
        {
           ...
           //send form by ajax
           var dataString = "token="+$("#token").val()+"&key0b20="+question0+"&key1b20="+question1+"&key2b20="+question2+"&key3b20="+question3+"&grade_1="+grade1+"&grade_2="+grade2+"&grade_3="+grade3+"&grade_4="+grade4+"&totalgrade="+actualScore+"&gradeunit=1&gradeactivity=2";
           if (completed == 2){
